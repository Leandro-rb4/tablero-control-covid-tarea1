...
qpal <- colorQuantile("Oranges", covid19_cr$confirmados, n = 7, na.color = "white")
    ...
    addPolygons(data = covid19_cr,
                ...
                dashArray = "3",
                fillOpacity = 0.7,
popup = paste(covid19_cr$canton, "Confirmados:", covid19_cr$confirmados, "Recuperados:", covid19_cr$recuperados, "Activos:", covid19_cr$activos, "Muertes:", covid19_cr$muertes, sep = '<br/>')) 
